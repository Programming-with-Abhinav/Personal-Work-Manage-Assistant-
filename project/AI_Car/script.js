...
window.addEventListener('keydown', (e) => { if (e.key in state.keys) state.keys[e.key] = true; });
window.addEventListener('keyup', (e) => { if (e.key in state.keys) state.keys[e.key] = false; });
