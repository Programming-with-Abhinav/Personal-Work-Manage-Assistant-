...
showResetPassword?.addEventListener("change", () => {
	...
	if (passwordField)
		passwordField.type = showResetPassword.checked ? "text" : "password";
	if (confirmField)
		confirmField.type = showResetPassword.checked ? "text" : "password";
});
...
resetPasswordForm?.addEventListener("submit", function (e) {
	...
	const userIndex = users.findIndex(
		(u) => u.email.toLowerCase() === resetEmail,
	);
